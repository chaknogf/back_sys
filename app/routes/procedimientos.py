...
from app.models.procedimientos import Procedimiento as ProcedimientoModel
from app.models.procedimientos import ProceMedico as ProceMedicoModel
from app.schemas.procedimientos import (
    ProcedimientoBase,
    ProcedimientoCreate,
    ProcedimientoUpdate,
    ProcedimientoOut,
...
#=================================
# Rutas para el catálogo de procedimientos
#=================================
...
def crear_procedimiento(
    ...
    # Validar que no exista ya un procedimiento con el mismo nombre o abreviatura
...
def actualizar_procedimiento(
    ...
    # Validar que no haya conflictos con nombre o abreviatura
...
def eliminar_procedimiento(
    ...
    # Verificar si tiene procedimientos médicos asociados
...
#=================================
# Rutas para los procedimientos realizados a pacientes
#=================================
...
#=================================
# Rutas adicionales para estadísticas
#=================================
