...
--
-- Name: actualizar_nombre_completo(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: constancia_medica_control; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento_control; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento_historial; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.constancia_nacimiento_historial (
    id integer NOT NULL,
...
--
-- Name: constancia_nacimiento_historial_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.constancia_nacimiento_historial_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: constancia_nacimiento_historial_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.constancia_nacimiento_historial_id_seq OWNED BY public.constancia_nacimiento_historial.id;


--
-- Name: constancia_nacimiento_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: defuncion_control; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: emergencia_control; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: eventos_consulta; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: eventos_consulta_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: eventos_consulta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: expediente_control; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: nacimientos_legacy; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.nacimientos_legacy (
    id integer NOT NULL,
    fecha date,
    cor integer,
    ao integer,
    doc character varying(12),
    fecha_parto date,
    ...
    libro integer,
    folio integer,
    partida character varying(10),
    muni integer,
    edad integer,
    vecindad integer,
    sexo_rn character varying(1),
    lb integer,
    onz integer,
    ...
    tipo_parto integer,
    clase_parto integer,
    certifica character varying(200),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
--
-- Name: nacimientos_legacy_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.nacimientos_legacy ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.nacimientos_legacy_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: paises_iso; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: paises_iso_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: paises_iso_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: vista_consultas; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: vista_totales; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento_historial id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.constancia_nacimiento_historial ALTER COLUMN id SET DEFAULT nextval('public.constancia_nacimiento_historial_id_seq'::regclass);
...
--
-- Name: eventos_consulta id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: paises_iso id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: constancia_medica_control constancia_medica_control_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento_control constancia_nacimiento_control_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento constancia_nacimiento_documento_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento_historial constancia_nacimiento_historial_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.constancia_nacimiento_historial
    ADD CONSTRAINT constancia_nacimiento_historial_pkey PRIMARY KEY (id);


--
-- Name: constancia_nacimiento constancia_nacimiento_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: defuncion_control defuncion_control_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: emergencia_control emergencia_control_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: eventos_consulta eventos_consulta_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: expediente_control expediente_control_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: nacimientos_legacy nacimientos_legacy_doc_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nacimientos_legacy
    ADD CONSTRAINT nacimientos_legacy_doc_key UNIQUE (doc);


--
-- Name: nacimientos_legacy nacimientos_legacy_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nacimientos_legacy
    ADD CONSTRAINT nacimientos_legacy_pkey PRIMARY KEY (id);


--
-- Name: pacientes pacientes_cui_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pacientes pacientes_expediente_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paises_iso paises_iso_codigo_iso3_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paises_iso paises_iso_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_codigo; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_consultas_ciclo_gin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_consultas_especialidad_servicio; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_consultas_expediente; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_consultas_fecha_consulta; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_consultas_indicadores_gin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_consultas_paciente_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_consultas_tipo_fecha; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_contacto_telefono; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_creado_en; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_datos_extra_gin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_eventos_consulta_consulta_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_eventos_consulta_datos_gin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_eventos_consulta_estado; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_eventos_consulta_responsable_gin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_eventos_consulta_tipo_evento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_fecha_nacimiento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_medicos_activo; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_medicos_colegiado; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_medicos_dpi; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_medicos_especialidad; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_medicos_nombre; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_nombre_apellido1; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_nombre_completo_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_nombre_primer; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paciente_nombre_json; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pacientes_contacto; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pacientes_datos_extra; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pacientes_estado; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pacientes_estado_personaid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pacientes_estado_personaid ON public.pacientes USING btree (estado, ((datos_extra ->> 'personaid'::text)));


--
-- Name: idx_pacientes_fecha_nacimiento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pacientes_nombre_fecha; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pacientes_nombre_fecha ON public.pacientes USING btree (upper(TRIM(BOTH FROM ((COALESCE((nombre ->> 'primer_nombre'::text), ''::text) || ' '::text) || COALESCE((nombre ->> 'primer_apellido'::text), ''::text)))), fecha_nacimiento) WHERE (estado <> 'I'::bpchar);


--
-- Name: idx_pacientes_nombre_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pacientes_nombre_gin ON public.pacientes USING gin (upper(TRIM(BOTH FROM ((COALESCE((nombre ->> 'primer_nombre'::text), ''::text) || ' '::text) || COALESCE((nombre ->> 'primer_apellido'::text), ''::text)))) public.gin_trgm_ops);


--
-- Name: idx_pacientes_personaid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pacientes_personaid ON public.pacientes USING btree (((datos_extra ->> 'personaid'::text))) WHERE ((estado <> 'I'::bpchar) AND (datos_extra ? 'personaid'::text));


--
-- Name: idx_pacientes_personaid_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pacientes_personaid_gin ON public.pacientes USING gin (datos_extra);


--
-- Name: idx_pacientes_referencias; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_referencias_gin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: citas fk_citas_paciente; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento fk_constancia_medico; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento fk_constancia_paciente; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento fk_constancia_registrador; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: constancia_nacimiento_historial fk_historial_constancia; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.constancia_nacimiento_historial
    ADD CONSTRAINT fk_historial_constancia FOREIGN KEY (constancia_id) REFERENCES public.constancia_nacimiento(id) ON DELETE CASCADE;


--
-- Name: constancia_nacimiento_historial fk_historial_usuario; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.constancia_nacimiento_historial
    ADD CONSTRAINT fk_historial_usuario FOREIGN KEY (usuario_id) REFERENCES public.users(id) ON DELETE RESTRICT;
