...
def listar(
    ...
    fecha_consulta: Optional[date] = Query(None, description="Fecha exacta de consulta (YYYY-MM-DD)"),
    ...
    nombre_paciente: Optional[str] = Query(None, max_length=150, description="Filtrar por nombre del paciente"),
    no_historia_clinica: Optional[str] = Query(None, max_length=150, description="Filtrar por historia clínica / expediente"),
