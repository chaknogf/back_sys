...
async def get_consultas(
    ...
    try:
        ...
        if identificador:
            query = query.filter(
                (VistaConsultasModel.cui == identificador) | (VistaConsultasModel.cui.cast(String).ilike(f"%{identificador}%")) |
                # (VistaConsultasModel.expediente == identificador) | (VistaConsultasModel.expediente.cast(String).ilike(f"%{identificador}%")) |
                ...
                # (VistaConsultasModel.documento == identificador) | (VistaConsultasModel.documento.cast(String).ilike(f"%{identificador}%")) 
                (VistaConsultasModel.documento.ilike(f"%{identificador}%")) 
